...
describe('Six — basic next two players draw', () => {
  it('should make the next two players each draw 1 card', () => {
    ...
    log('Verify: two CARD_DRAWN events');
